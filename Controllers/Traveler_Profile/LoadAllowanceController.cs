...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
   // [ApiController]
    ...
    public class LoadAllowanceController : ControllerBase
    {
        ...
        [HttpPost("LoadAllowance", Name = "LoadAllowance")]
        public IActionResult Post([FromBody]AllowanceModel value)
        {
            ...
            mLog.tevent = "SearchAllowance";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SearchAllowance(value);
