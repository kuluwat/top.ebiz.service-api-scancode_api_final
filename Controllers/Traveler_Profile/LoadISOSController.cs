...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
    ...
    public class LoadISOSController : ControllerBase
    {
        ...
        [HttpPost("LoadISOS", Name = "LoadISOS")]
        public IActionResult Post([FromBody] ISOSModel value)
        {
            ...
            mLog.module = "ISOS";
            mLog.tevent = "SearchISOS";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SearchISOS(value);
