...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
    ...
    public class SendMailTransportationController : ControllerBase
    {
        ...
        [HttpPost("SendMailTransportation", Name = "SendMailTransportation")]
        public IActionResult Post([FromBody] TransportationOutModel value)
        {
            ...
            mLog.tevent = "SendMailTransportation";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SendMailTransportation(value);
