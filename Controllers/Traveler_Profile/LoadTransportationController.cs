...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
    ...
    public class LoadTransportationController : ControllerBase
    {
        ...
        [HttpPost("LoadTransportation", Name = "LoadTransportation")]
        public IActionResult Post([FromBody] TransportationModel value)
        {
            ...
            mLog.tevent = "SearchTransportation";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SearchTransportation(value);
