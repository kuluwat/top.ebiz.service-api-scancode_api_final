...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
    ...
    public class SendMailISOSController : ControllerBase
    {
        ...
        [HttpPost("SendMailISOS", Name = "SendMailISOS")]
        public IActionResult Post([FromBody] ISOSOutModel value)
        {
            ...
            mLog.module = "ISOS";
            mLog.tevent = "SendMailISOS";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SendMailISOS(value);
