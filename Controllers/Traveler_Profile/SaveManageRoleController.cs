...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
    ...
    public class SaveManageRoleController : ControllerBase
    {
        ...
        [HttpPost("SaveManageRole", Name = "SaveManageRole")]
        public IActionResult Post([FromBody] ManageRoleOutModel value)
        {
            ...
            mLog.tevent = "SetManageRole";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SetManageRole(value);
