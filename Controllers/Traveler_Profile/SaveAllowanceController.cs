...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
    ...
    public class SaveAllowanceController : ControllerBase
    {
        ...
        [HttpPost("SaveAllowance", Name = "SaveAllowance")]
        public IActionResult Post([FromBody] AllowanceOutModel value)
        {
            ...
            mLog.tevent = "SetAllowance";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SetAllowance(value);
