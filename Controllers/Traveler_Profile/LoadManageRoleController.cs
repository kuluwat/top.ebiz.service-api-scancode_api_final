...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
    ...
    public class LoadManageRoleController : ControllerBase
    {
        ...
        [HttpPost("LoadManageRole", Name = "LoadManageRole")]
        public IActionResult Post([FromBody] ManageRoleModel value)
        {
            ...
            mLog.module = "ManageRole";
            mLog.tevent = "SearchManageRole";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SearchManageRole(value);
