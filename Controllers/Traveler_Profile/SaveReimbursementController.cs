...
namespace top.ebiz.service.Controllers.Traveler_Profile
{
   // [ApiController]
    ...
    public class SaveReimbursementController : ControllerBase
    {
...
public string Get(int id)
{
    return "value";
        ...
        [HttpPost("SaveReimbursement", Name = "SaveReimbursement")]
public IActionResult Post([FromBody]ReimbursementOutModel value)
        {
            ...
            mLog.tevent = "SetReimbursement";
            mLog.ref_id = 0;
            mLog.data_log = JsonSerializer.Serialize(value);
            //logService.insertLog(mLog);

            HttpResponseMessage response = null;
            Object result = service.SetReimbursement(value);
